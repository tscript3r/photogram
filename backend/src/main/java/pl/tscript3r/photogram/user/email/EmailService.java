...
import static pl.tscript3r.photogram.user.email.EmailMessageType.EMAIL_CONFIRMATION;
import static pl.tscript3r.photogram.user.email.EmailMessageType.PASSWORD_RESET;
