...
public class PostController {
    ...
    public static final String DISLIKE_MAPPING = "/dislike";
    public static final String UNDISLIKE_MAPPING = "/undislike";
    public static final String UPLOAD_IMAGE_MAPPING = "/upload";
    ...
    public PostDto like(Principal principal, @PathVariable(ID_VARIABLE) Long postId) {
        return postService.react(Reactions.LIKE, principal, postId);
    }
    ...
    public PostDto unlike(Principal principal, @PathVariable(ID_VARIABLE) Long postId) {
        return postService.react(Reactions.UNLIKE, principal, postId);
    }
    ...
    public PostDto dislike(Principal principal, @PathVariable(ID_VARIABLE) Long postId) {
        return postService.react(Reactions.DISLIKE, principal, postId);
    }
    ...
    public PostDto undislike(Principal principal, @PathVariable(ID_VARIABLE) Long postId) {
        return postService.react(Reactions.UNDISLIKE, principal, postId);
    }
